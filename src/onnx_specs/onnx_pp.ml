...
let rec pp_attribute_proto_attribute_type fmt (v:Onnx_types.attribute_proto_attribute_type) =
  match v with
...
let rec pp_sparse_tensor_proto fmt (v:Onnx_types.sparse_tensor_proto) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "values" (Pbrt.Pp.pp_option pp_tensor_proto) fmt v.Onnx_types.values;
    Pbrt.Pp.pp_record_field "indices" (Pbrt.Pp.pp_option pp_tensor_proto) fmt v.Onnx_types.indices;
    Pbrt.Pp.pp_record_field "dims" (Pbrt.Pp.pp_list Pbrt.Pp.pp_int64) fmt v.Onnx_types.dims;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()

let rec pp_tensor_shape_proto_dimension_value fmt (v:Onnx_types.tensor_shape_proto_dimension_value) =
  match v with
...
let rec pp_tensor_shape_proto fmt (v:Onnx_types.tensor_shape_proto) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "dim" (Pbrt.Pp.pp_list pp_tensor_shape_proto_dimension) fmt v.Onnx_types.dim;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
let rec pp_type_proto_value fmt (v:Onnx_types.type_proto_value) =
  match v with
  | Onnx_types.Tensor_type x -> Format.fprintf fmt "@[Tensor_type(%a)@]" pp_type_proto_tensor x
  | Onnx_types.Sequence_type x -> Format.fprintf fmt "@[Sequence_type(%a)@]" pp_type_proto_sequence x
...
and pp_type_proto_sequence fmt (v:Onnx_types.type_proto_sequence) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "elem_type" (Pbrt.Pp.pp_option pp_type_proto) fmt v.Onnx_types.elem_type;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
let rec pp_attribute_proto fmt (v:Onnx_types.attribute_proto) = 
  let pp_i fmt () =
    ...
    Pbrt.Pp.pp_record_field "floats" (Pbrt.Pp.pp_list Pbrt.Pp.pp_float) fmt v.Onnx_types.floats;
    Pbrt.Pp.pp_record_field "ints" (Pbrt.Pp.pp_list Pbrt.Pp.pp_int64) fmt v.Onnx_types.ints;
    Pbrt.Pp.pp_record_field "strings" (Pbrt.Pp.pp_list Pbrt.Pp.pp_bytes) fmt v.Onnx_types.strings;
    Pbrt.Pp.pp_record_field "tensors" (Pbrt.Pp.pp_list pp_tensor_proto) fmt v.Onnx_types.tensors;
    Pbrt.Pp.pp_record_field "graphs" (Pbrt.Pp.pp_list pp_graph_proto) fmt v.Onnx_types.graphs;
    Pbrt.Pp.pp_record_field "sparse_tensors" (Pbrt.Pp.pp_list pp_sparse_tensor_proto) fmt v.Onnx_types.sparse_tensors;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
and pp_graph_proto fmt (v:Onnx_types.graph_proto) = 
  let pp_i fmt () =
    ...
    Pbrt.Pp.pp_record_field "quantization_annotation" (Pbrt.Pp.pp_list pp_tensor_annotation) fmt v.Onnx_types.quantization_annotation;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
