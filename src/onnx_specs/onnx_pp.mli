...
val pp_attribute_proto_attribute_type : Format.formatter -> Onnx_types.attribute_proto_attribute_type -> unit 
...
val pp_string_string_entry_proto : Format.formatter -> Onnx_types.string_string_entry_proto -> unit 
(** [pp_string_string_entry_proto v] formats v *)

val pp_tensor_proto_data_location : Format.formatter -> Onnx_types.tensor_proto_data_location -> unit 
...
val pp_tensor_shape_proto_dimension_value : Format.formatter -> Onnx_types.tensor_shape_proto_dimension_value -> unit 
(** [pp_tensor_shape_proto_dimension_value v] formats v *)

val pp_tensor_shape_proto_dimension : Format.formatter -> Onnx_types.tensor_shape_proto_dimension -> unit 
...
val pp_operator_set_id_proto : Format.formatter -> Onnx_types.operator_set_id_proto -> unit 
...
val pp_tensor_proto_data_type : Format.formatter -> Onnx_types.tensor_proto_data_type -> unit 
